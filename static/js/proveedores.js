...
function filterSuppliers(searchTerm) {
    ...
    if (!visibleRows && searchTerm !== '') {
        suppliersTbody.innerHTML = '<tr><td colspan="6" style="text-align: center; padding: 2rem; color: #999;">No se encontraron proveedores con "' + searchTerm.toUpperCase() + '"</td></tr>';
    }
}
